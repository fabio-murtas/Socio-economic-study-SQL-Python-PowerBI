...
This data package contains the data that powers the chart ["Population"](https://ourworldindata.org/grapher/population?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 21, 2026.
