...
This data package contains the data that powers the chart ["Energy use per person"](https://ourworldindata.org/grapher/per-capita-energy-use?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on May 29, 2026.
